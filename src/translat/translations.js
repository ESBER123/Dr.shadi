const translations = {
  en: {
    ...
    heroLabel: "Modern Orthodontic Clinic",

    heroTitleBefore: "Orthodontics.",
    heroTitleHighlight: "For a smile",
    ...
    aboutLabel: "About Our Clinic",

    aboutTitleBefore: "Orthodontics.",
    aboutTitleHighlight: "For a smile that lasts.",

    aboutLead:
      "We create healthy, functional and naturally beautiful smiles with individual treatment planning and personal care.",

    aboutText:
      "Orthodontic treatment is about more than straight teeth. We consider the relationship between your teeth, jaws and bite to create a result that is healthy, functional and aesthetically pleasing.",

    aboutPoints: [
      "Individual treatment plans",
      "Modern diagnostics and digital technology",
      "Treatment for children, teenagers and adults",
      "Personal care from start to finish",
    ],

    aboutImageAlt: "Orthodontic treatment",
    ...
    orthodonticsLabel: "Treatments",

    orthodonticsTitleBefore: "Treatments",
    ...
    treatmentAlignersText:
      "Discreet tooth alignment with individually planned aligners — comfortable and virtually invisible in everyday life.",

    treatmentFixedBracesTitle: "Fixed Braces",

    treatmentFixedBracesText:
      "A proven orthodontic treatment for controlled tooth movement and precise treatment planning.",

    treatmentChildrenTitle: "Children & Teenagers",

    treatmentChildrenText:
      "Early assessment, individual treatment planning and gentle orthodontic care during growth.",

    invisibleAligners: "Invisible Aligners",
    ...
    fixedBracesText:
      "A proven orthodontic treatment for precise tooth movement and reliable results.",

    childrenTeenagers: "Children & Teenagers",
    ...
    diagnosticsTitle: "Modern diagnostics for precise treatment planning",
    ...
    modJawText: "Precise analysis of natural jaw movement in 4D.",

    dvtTitle: "3D Imaging (DVT)",
    ...
    modJawDescription: "Precise analysis of natural jaw movement in 4D.",

    threeDImaging: "3D Imaging (DVT)",
    ...
    objectiveLabel: "Our Goal",

    objectiveTitle:
      "Our goal is a healthy, functional bite and a naturally beautiful smile.",
    ...
    objectivePoints: [
      ...
      "Precise alignment of the teeth",
      "Balanced relationship between teeth and jaws",
    ...
    objectiveExpectationsLabel: "Our Approach",

    objectiveExpectationsTitle:
      "Individual treatment. Clear goals. Long-term results.",

    objectiveExpectationsText:
      "We combine precise diagnostics, modern orthodontic techniques and personal care to create a treatment plan tailored to your individual needs.",

    objectiveExpectationsIntro:
      "Every patient has different needs and goals. That is why we assess your individual situation carefully before recommending the right treatment.",
    ...
    objectiveAttentionText:
      "We look at more than the position of individual teeth. The relationship between your teeth, jaws and bite is an important part of creating a healthy, functional and aesthetically pleasing result.",

    objectiveOurApproach: "Our approach",
    ...
    expectationsListTitle: "What you can expect from us",

    expectationsList: [
      "Individual treatment planning",
      "Modern diagnostics and technology",
      "Personal care throughout treatment",
    ],
    ...
    expectationsImageAlt: "Patient receiving orthodontic treatment",

    // =========================================================
    // CHILDREN
    // =========================================================

    childrenLabel: "Children & Teenagers",

    childrenTitle: "Gentle orthodontic care from an early age.",

    childrenText:
      "We accompany children and teenagers through their orthodontic development with individual treatment plans and personal attention. Early assessment allows us to recognise developing tooth and jaw problems and determine when treatment is appropriate.",

    childrenFactorsTitle: "Individual care during growth",

    childrenFactors: [
      "Early assessment",
      "Individual treatment planning",
      "Monitoring tooth and jaw development",
      "Gentle orthodontic care",
      "Personal attention",
    ],
    ...
    mixedDentitionTitle: "Treatment during dental development",

    mixedDentitionText:
      "Early assessment helps us recognise developing tooth and jaw problems and determine the right time for orthodontic treatment.",

    mixedDentitionNote:
      "Every child develops differently. We therefore assess the individual dental and jaw development before recommending whether and when treatment is appropriate.",

    // =========================================================
    // PERMANENT DENTITION
    // =========================================================

    permanentDentitionTitle: "Treatment of the permanent dentition",

    permanentDentitionText:
      "For teenagers and adults, we develop an individual treatment plan based on the position of the teeth, the jaws and the bite. Depending on the situation, modern fixed braces or other orthodontic solutions may be recommended.",
    ...
    adultsTitle: "Orthodontics for adults — discreet, precise and individual.",

    adultsText:
      "Whether you want to improve the appearance of your smile, optimise your bite or address a more complex orthodontic problem, we develop a treatment plan tailored to your individual needs.",

    adultsAdditionalText:
      "Invisible aligners and modern fixed braces can make orthodontic treatment discreet and comfortable — even in adulthood.",

    adultsPoints: [
      "Individual treatment planning",
      "Discreet orthodontic treatment options",
      "Invisible aligners where appropriate",
      "Modern fixed braces where appropriate",
      "Solutions tailored to complex orthodontic needs",
    ],
    ...
    promiseLabel: "Why Choose Us?",

    promiseTitleBefore: "Personal.",
    promiseTitleHighlight: "Precise. Long-term.",
    ...
    features: [
      {
        icon: "♡",
        title: "Personal",
        text: "Every treatment plan is individually tailored to your needs, wishes and clinical situation.",
      },
      {
        icon: "✦",
        title: "Precise",
        text: "Modern diagnostics and digital technology support precise treatment planning.",
      },
      {
        icon: "∞",
        title: "Long-term",
    ...
    quote:
      "Every treatment is planned individually with the goal of creating a healthy, functional and naturally beautiful smile.",
  ...
  de: {
    ...
    aboutLead:
      "Wir schaffen gesunde, funktionelle und natürlich schöne Lächeln mit individueller Behandlungsplanung und persönlicher Betreuung.",

    aboutText:
      "Eine kieferorthopädische Behandlung bedeutet mehr als gerade Zähne. Wir betrachten das Zusammenspiel von Zähnen, Kiefern und Biss, um ein gesundes, funktionelles und ästhetisch ansprechendes Ergebnis zu schaffen.",

    aboutPoints: [
      "Individuelle Behandlungspläne",
      "Moderne Diagnostik und digitale Technologie",
    ...
    objectivePoints: [
      "Ein gesunder und funktioneller Biss",
      "Eine präzise Ausrichtung der Zähne",
      "Ein harmonisches Zusammenspiel von Zähnen und Kiefern",
    ...
    expectationsList: [
      ...
      "Persönliche Betreuung während der Behandlung",
    ],
    ...
    expectationsImageAlt:
      "Patient während einer kieferorthopädischen Behandlung",
    ...
    childrenFactors: [
      ...
      "Individuelle Behandlungsplanung",
      "Beobachtung der Zahn- und Kieferentwicklung",
      "Einfühlsame kieferorthopädische Betreuung",
    ...
    mixedDentitionNote:
      "Jedes Kind entwickelt sich unterschiedlich. Deshalb beurteilen wir die individuelle Zahn- und Kieferentwicklung, bevor wir entscheiden, ob und wann eine Behandlung sinnvoll ist.",
    ...
    adultsText:
      "Ob Sie das Aussehen Ihres Lächelns verbessern, Ihren Biss optimieren oder ein komplexeres kieferorthopädisches Problem behandeln möchten – wir entwickeln einen Behandlungsplan, der auf Ihre individuellen Bedürfnisse abgestimmt ist.",

    adultsAdditionalText:
      "Unsichtbare Aligner und moderne feste Zahnspangen können eine kieferorthopädische Behandlung auch im Erwachsenenalter diskret und komfortabel gestalten.",

    adultsPoints: [
      "Individuelle Behandlungsplanung",
      "Diskrete kieferorthopädische Behandlungsmöglichkeiten",
      "Unsichtbare Aligner, wenn geeignet",
      "Moderne feste Zahnspangen, wenn geeignet",
      "Lösungen für komplexe kieferorthopädische Situationen",
    ],
