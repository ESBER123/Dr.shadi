const contactTranslations = {
  en: {
    ...
    practiceTitleHighlight: " to  hear from you.",
  ...
  de: {
    ...
    headerLabel: "KONTAKT AUFNEHMEN",
    headerTitleBefore: "Sprechen wir über",
    headerTitleHighlight: "Ihr Lächeln.",
    headerText:
