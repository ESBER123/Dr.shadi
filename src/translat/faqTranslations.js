const faqTranslations = {
  en: {
    hero: {
      ...
      titleSecond: "to know.",
      description:
        "Important information and answers to the most common questions about orthodontic treatment.",
      button: "Explore questions",
    },
  ...
  de: {
    hero: {
      ...
      titleSecond: "sollten.",
      description:
        "Wichtige Informationen und Antworten auf häufige Fragen zur kieferorthopädischen Behandlung.",
      button: "Fragen entdecken",
    },
    ...
    faq: {
      ...
      description:
        "Hier finden Sie Antworten auf die wichtigsten Fragen rund um Zahnspangen und kieferorthopädische Behandlungen.",
